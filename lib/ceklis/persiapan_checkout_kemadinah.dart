...
class PersiapanCheckoutKemadinah extends StatefulWidget {
  @override
  _PersiapanCheckoutKemadinahState createState() =>
      _PersiapanCheckoutKemadinahState();
}

class _PersiapanCheckoutKemadinahState
    extends State<PersiapanCheckoutKemadinah> {
  ...
  final List<String> taskDescriptions = [
    ...
    '2. Petugas mengingatkan jamaah untuk berkemas dan bersiap-siap menuju kota Madinah.',
    '3. Hubungi supir bus untuk memastikan bus tersedia dan hadir tepat waktu.',
    '4. Kumpulkan kunci kamar di lobi dan pastikan tidak ada barang jamaah yang tertinggal.',
    '5. Saat memasukkan koper ke bagasi bus, pastikan semua koper jamaah lengkap.',
    '6. Berikan gambaran singkat kepada jamaah tentang keadaan Raudhah dan tingkat kepadatannya di Masjid Nabawi.',
  ];
    ...
    if (_formKey.currentState!.validate() && !selectedOptions.contains(null)) {
      ...
      try {
        final response = await http.post(
          ...
          body: jsonEncode({
            "nama": "Persiapan Checkout dan Transisi ke Madinah",
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text('Persiapan Checkout dan Transisi ke Madinah'),
