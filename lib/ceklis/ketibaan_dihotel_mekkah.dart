...
class KetibaanDihotelMekkah extends StatefulWidget {
  @override
  _KetibaanDihotelMekkahState createState() => _KetibaanDihotelMekkahState();
}

class _KetibaanDihotelMekkahState extends State<KetibaanDihotelMekkah> {
    ...
    if (_formKey.currentState!.validate() && !selectedOptions.contains(null)) {
      ...
      try {
        final response = await http.post(
          ...
          body: jsonEncode({
            "nama": "Ketibaan di Hotel dan Check-in (Mekkah)",
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text('Ketibaan di Hotel dan Check-in (Mekkah)'),
